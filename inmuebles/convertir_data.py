...
with open('regiones_comunas2.json', 'w', encoding='utf-8') as f:
    json.dump(fixtures, f, ensure_ascii=False, indent=4)

print("Archivo regiones_comunas2.json creado exitosamente.")